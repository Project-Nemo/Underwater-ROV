...
void viewIMUData() {
  Serial.println("AccX:");
  Serial.println(rxdata.AccX);
  Serial.println(" AccY:");
  Serial.println(rxdata.AccY);
  Serial.println(" AccZ:");
  Serial.println(rxdata.AccZ);
  Serial.println(" GyroX:");
  Serial.println(rxdata.GyroX);
  Serial.println(" GyroY:");
  Serial.println(rxdata.GyroY);
  Serial.println(" GyroZ:");
  Serial.println(rxdata.GyroZ);
}
