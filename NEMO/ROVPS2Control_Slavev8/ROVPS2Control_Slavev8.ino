...
void setup()
{
  ...
  ESCVL.attach(8,0,100); //attach the ESCVL to pin 8 
  ESCVR.attach(7,0,100); //attach the ESCVR to pin 7
  ESCHL.attach(6,0,100); //attach the ESCHL to pin 6
  ESCHR.attach(5,0,100); //attach the ESCHR to pin 5
...
ESCVL.write(0);  //Set the ESCVL signal to the neutral position.
ESCVR.write(90);  //Set the ESCVL signal to the neutral position.
ESCHL.write(180);  //Set the ESCVL signal to the neutral position.
ESCHR.write(360);  //Set the ESCVL signal to the neutral position.
...
void loop()
{
 ...
 //process runs smoothly.
  for(int i=0; i<5; i++){
    ...
    ESCVL.write(0);  //Set the ESCVL signal to the defined throttle position.
    ESCVR.write(90);  //Set the ESCVR signal to the defined throttle position.
    ESCHL.write(180);  //Set the ESCHL signal to the defined throttle position.
    ESCHR.write(360);  //Set the ESCHR signal to the defined throttle position.
    Serial.print("Here!");
